...
const (
	...
	StringRules_PRECIS_NICKNAME StringRules_UnicodeNormalizationForm = 103
)
...
func (x *FieldRules) GetItems() isFieldRules_Items {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *FieldRules) GetRepeated() *ItemsRules {
	if x != nil {
		if x, ok := x.Items.(*FieldRules_Repeated); ok {
			return x.Repeated
		}
	}
	return nil
...
func (x *FieldRules) GetMap() *ItemsRules {
	if x != nil {
		if x, ok := x.Items.(*FieldRules_Map); ok {
			return x.Map
		}
	}
	return nil
...
func (x *StringRules) GetPredefined() isStringRules_Predefined {
	if x != nil {
		return x.Predefined
	}
	return nil
...
func (x *StringRules) GetEmail() bool {
	if x != nil {
		if x, ok := x.Predefined.(*StringRules_Email); ok {
			return x.Email
		}
	}
	return false
...
func (x *StringRules) GetUri() bool {
	if x != nil {
		if x, ok := x.Predefined.(*StringRules_Uri); ok {
			return x.Uri
		}
	}
	return false
...
func (x *StringRules) GetE164() bool {
	if x != nil {
		if x, ok := x.Predefined.(*StringRules_E164); ok {
			return x.E164
		}
	}
	return false
...
const file_cybozu_validate_options_proto_rawDesc = "" +
	"\n" +
	"\x1dcybozu/validate/options.proto\x12\x0fcybozu.validate\x1a google/protobuf/descriptor.proto\"\xb6\b\n" +
	"\n" +
	"FieldRules\x123\n" +
	"\x05float\x18\x01 \x01(\v2\x1b.cybozu.validate.FloatRulesH\x00R\x05float\x126\n" +
	"\x06double\x18\x02 \x01(\v2\x1c.cybozu.validate.DoubleRulesH\x00R\x06double\x123\n" +
	"\x05int32\x18\x03 \x01(\v2\x1b.cybozu.validate.Int32RulesH\x00R\x05int32\x123\n" +
	"\x05int64\x18\x04 \x01(\v2\x1b.cybozu.validate.Int64RulesH\x00R\x05int64\x126\n" +
	"\x06uint32\x18\x05 \x01(\v2\x1c.cybozu.validate.Uint32RulesH\x00R\x06uint32\x126\n" +
	"\x06uint64\x18\x06 \x01(\v2\x1c.cybozu.validate.Uint64RulesH\x00R\x06uint64\x125\n" +
	"\x06sint32\x18\a \x01(\v2\x1b.cybozu.validate.Int32RulesH\x00R\x06sint32\x125\n" +
	"\x06sint64\x18\b \x01(\v2\x1b.cybozu.validate.Int64RulesH\x00R\x06sint64\x128\n" +
	"\afixed32\x18\t \x01(\v2\x1c.cybozu.validate.Uint32RulesH\x00R\afixed32\x128\n" +
	"\afixed64\x18\n" +
	" \x01(\v2\x1c.cybozu.validate.Uint64RulesH\x00R\afixed64\x129\n" +
	"\bsfixed32\x18\v \x01(\v2\x1b.cybozu.validate.Int32RulesH\x00R\bsfixed32\x129\n" +
	"\bsfixed64\x18\f \x01(\v2\x1b.cybozu.validate.Int64RulesH\x00R\bsfixed64\x120\n" +
	"\x04bool\x18\r \x01(\v2\x1a.cybozu.validate.BoolRulesH\x00R\x04bool\x126\n" +
	"\x06string\x18\x0e \x01(\v2\x1c.cybozu.validate.StringRulesH\x00R\x06string\x123\n" +
	"\x05bytes\x18\x0f \x01(\v2\x1b.cybozu.validate.BytesRulesH\x00R\x05bytes\x120\n" +
	"\x04enum\x18\x10 \x01(\v2\x1a.cybozu.validate.EnumRulesH\x00R\x04enum\x129\n" +
	"\amessage\x18\x11 \x01(\v2\x1d.cybozu.validate.MessageRulesH\x00R\amessage\x12:\n" +
	"\brepeated\x18\xe8\a \x01(\v2\x1b.cybozu.validate.ItemsRulesH\x01R\brepeated\x120\n" +
	"\x03map\x18\xe9\a \x01(\v2\x1b.cybozu.validate.ItemsRulesH\x01R\x03mapB\x06\n" +
	"\x04typeB\a\n" +
	"\x05items\"l\n" +
	"\n" +
	"ItemsRules\x12 \n" +
	"\tmin_items\x18\x01 \x01(\rH\x00R\bminItems\x88\x01\x01\x12 \n" +
	"\tmax_items\x18\x02 \x01(\rH\x01R\bmaxItems\x88\x01\x01B\f\n" +
	"\n" +
	"_min_itemsB\f\n" +
	"\n" +
	"_max_items\"\x82\x01\n" +
	"\n" +
	"FloatRules\x12\x13\n" +
	"\x02lt\x18\x01 \x01(\x02H\x00R\x02lt\x88\x01\x01\x12\x15\n" +
	"\x03lte\x18\x02 \x01(\x02H\x01R\x03lte\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x03 \x01(\x02H\x02R\x02gt\x88\x01\x01\x12\x15\n" +
	"\x03gte\x18\x04 \x01(\x02H\x03R\x03gte\x88\x01\x01B\x05\n" +
	"\x03_ltB\x06\n" +
	"\x04_lteB\x05\n" +
	"\x03_gtB\x06\n" +
	"\x04_gte\"\x83\x01\n" +
	"\vDoubleRules\x12\x13\n" +
	"\x02lt\x18\x01 \x01(\x01H\x00R\x02lt\x88\x01\x01\x12\x15\n" +
	"\x03lte\x18\x02 \x01(\x01H\x01R\x03lte\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x03 \x01(\x01H\x02R\x02gt\x88\x01\x01\x12\x15\n" +
	"\x03gte\x18\x04 \x01(\x01H\x03R\x03gte\x88\x01\x01B\x05\n" +
	"\x03_ltB\x06\n" +
	"\x04_lteB\x05\n" +
	"\x03_gtB\x06\n" +
	"\x04_gte\"\x82\x01\n" +
	"\n" +
	"Int32Rules\x12\x13\n" +
	"\x02lt\x18\x01 \x01(\x05H\x00R\x02lt\x88\x01\x01\x12\x15\n" +
	"\x03lte\x18\x02 \x01(\x05H\x01R\x03lte\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x03 \x01(\x05H\x02R\x02gt\x88\x01\x01\x12\x15\n" +
	"\x03gte\x18\x04 \x01(\x05H\x03R\x03gte\x88\x01\x01B\x05\n" +
	"\x03_ltB\x06\n" +
	"\x04_lteB\x05\n" +
	"\x03_gtB\x06\n" +
	"\x04_gte\"\x82\x01\n" +
	"\n" +
	"Int64Rules\x12\x13\n" +
	"\x02lt\x18\x01 \x01(\x03H\x00R\x02lt\x88\x01\x01\x12\x15\n" +
	"\x03lte\x18\x02 \x01(\x03H\x01R\x03lte\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x03 \x01(\x03H\x02R\x02gt\x88\x01\x01\x12\x15\n" +
	"\x03gte\x18\x04 \x01(\x03H\x03R\x03gte\x88\x01\x01B\x05\n" +
	"\x03_ltB\x06\n" +
	"\x04_lteB\x05\n" +
	"\x03_gtB\x06\n" +
	"\x04_gte\"\x83\x01\n" +
	"\vUint32Rules\x12\x13\n" +
	"\x02lt\x18\x01 \x01(\rH\x00R\x02lt\x88\x01\x01\x12\x15\n" +
	"\x03lte\x18\x02 \x01(\rH\x01R\x03lte\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x03 \x01(\rH\x02R\x02gt\x88\x01\x01\x12\x15\n" +
	"\x03gte\x18\x04 \x01(\rH\x03R\x03gte\x88\x01\x01B\x05\n" +
	"\x03_ltB\x06\n" +
	"\x04_lteB\x05\n" +
	"\x03_gtB\x06\n" +
	"\x04_gte\"\x83\x01\n" +
	"\vUint64Rules\x12\x13\n" +
	...
	"\tBoolRules\"\x8d\x04\n" +
	"\vStringRules\x12I\n" +
	"\x04norm\x18\x01 \x01(\x0e25.cybozu.validate.StringRules.UnicodeNormalizationFormR\x04norm\x12!\n" +
	"\fignore_empty\x18\x02 \x01(\bR\vignoreEmpty\x12\"\n" +
	"\n" +
	"min_length\x18\x03 \x01(\rH\x01R\tminLength\x88\x01\x01\x12\"\n" +
	"\n" +
	"max_length\x18\x04 \x01(\rH\x02R\tmaxLength\x88\x01\x01\x12\x19\n" +
	"\x05regex\x18\x05 \x01(\tH\x03R\x05regex\x88\x01\x01\x12\x16\n" +
	"\x05email\x18d \x01(\bH\x00R\x05email\x12\x12\n" +
	"\x03uri\x18e \x01(\bH\x00R\x03uri\x12\x14\n" +
	"\x04e164\x18f \x01(\bH\x00R\x04e164\"\xb4\x01\n" +
	"\x18UnicodeNormalizationForm\x12\a\n" +
	"\x03NFC\x10\x00\x12\a\n" +
	"\x03NFD\x10\x01\x12\b\n" +
	"\x04NFKC\x10\x02\x12\b\n" +
	"\x04NFKD\x10\x03\x12\x1f\n" +
	"\x1bPRECIS_USERNAME_CASE_MAPPED\x10d\x12\"\n" +
	"\x1ePRECIS_USERNAME_CASE_PRESERVED\x10e\x12\x18\n" +
	"\x14PRECIS_OPAQUE_STRING\x10f\x12\x13\n" +
	"\x0fPRECIS_NICKNAME\x10gB\f\n" +
	"\n" +
	"predefinedB\r\n" +
	"\v_min_lengthB\r\n" +
	"\v_max_lengthB\b\n" +
	...
	"BytesRules\x12\"\n" +
	"\n" +
	"min_length\x18\x03 \x01(\rH\x00R\tminLength\x88\x01\x01\x12\"\n" +
	"\n" +
	"max_length\x18\x04 \x01(\rH\x01R\tmaxLength\x88\x01\x01B\r\n" +
	"\v_min_lengthB\r\n" +
	"\v_max_length\"J\n" +
	"\tEnumRules\x12\x1a\n" +
	"\brequired\x18\x01 \x01(\bR\brequired\x12!\n" +
	"\fdefined_only\x18\x02 \x01(\bR\vdefinedOnly\"*\n" +
	"\fMessageRules\x12\x1a\n" +
	"\brequired\x18\x01 \x01(\bR\brequired::\n" +
	"\aignored\x12\x1f.google.protobuf.MessageOptions\x18\x9b\t \x01(\bR\aignored::\n" +
	"\brequired\x12\x1d.google.protobuf.OneofOptions\x18\x9b\t \x01(\bR\brequired:Q\n" +
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\x9b\t \x01(\v2\x1b.cybozu.validate.FieldRulesR\x05rulesB,Z*github.com/cybozu/protobuf/cybozu/validateb\x06proto3"

var (
	file_cybozu_validate_options_proto_rawDescOnce sync.Once
	file_cybozu_validate_options_proto_rawDescData []byte
)

func file_cybozu_validate_options_proto_rawDescGZIP() []byte {
	file_cybozu_validate_options_proto_rawDescOnce.Do(func() {
		file_cybozu_validate_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cybozu_validate_options_proto_rawDesc), len(file_cybozu_validate_options_proto_rawDesc)))
	})
...
func file_cybozu_validate_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cybozu_validate_options_proto_rawDesc), len(file_cybozu_validate_options_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   13,
			NumExtensions: 3,
			NumServices:   0,
